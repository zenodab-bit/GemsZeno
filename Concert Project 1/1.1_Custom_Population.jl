...
people = JLD2.load("Concert Project/Datastorage/people_Saalekreis.jld2")["data"]

# Load the settings dataset containing configurations for various locations
data_settings = JLD2.load("Concert Project/Datastorage/settings_Saalekreis.jld2")["data"]
...
data = people
JLD2.@save "Concert Project/Datastorage/people_Saalekreis_concert.jld2" data

# Reload the saved data to verify it was written correctly
newpeople = JLD2.load("Concert Project/Datastorage/people_Saalekreis_concert.jld2")["data"]
