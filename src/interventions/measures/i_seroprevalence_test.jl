...
"""
struct SeroprevalenceTest <: IMeasure
    name::String    # name of testing measure (i.e. "test_after_symptoms")
    type::SeroprevalenceTestType  # test type / brand / make
    ...
    function SeroprevalenceTest(name::String, type, positive_followup, negative_followup; reportable = true)
    ...
    SeroprevalenceTest(name, type; positive_followup = nothing, negative_followup = nothing, reportable = true) = 
    SeroprevalenceTest(name, type, positive_followup, negative_followup, reportable = reportable)

    SeroprevalenceTest(;name = "", type = nothing, positive_followup = nothing, negative_followup = nothing, reportable = true) = 
    SeroprevalenceTest(name, type, positive_followup, negative_followup, reportable = reportable)
end
...
"""
function name(t::SeroprevalenceTest)
    return(t.name)
end
...
"""
function type(t::SeroprevalenceTest)
    return(t.type)
end
...
"""
function positive_followup(t::SeroprevalenceTest)
...
"""
function negative_followup(t::SeroprevalenceTest)
...
"""
function reportable(t::SeroprevalenceTest)
    return(t.reportable)
end
...
"""
function process_measure(sim::Simulation, ind::Individual, test::SeroprevalenceTest)
