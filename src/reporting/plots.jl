...
| `:TickSeroTests`                 | Number of seroprevalence tests and their results per tick.                            | Yes        | `detailed::Bool = false`: Whether to show detailed breakdown (TP, FP, TN, FN). Only for single plots.                                          |
