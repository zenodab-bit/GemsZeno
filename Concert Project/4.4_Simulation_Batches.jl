...
# Get ResultData for each simulation
...
## === Plot: Total Cases ===
# Use the first simulation's ResultData for the general plot
gp_total = gemsplot(sim_results[1])
...
## END
println("END SIMULATION 4.4 BATCHES")